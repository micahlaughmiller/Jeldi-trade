...
import logging
import sys
from api_handler import AlpacaOrderHandler
...
class TradingScheduler:
    """ASTRA Trading Scheduler"""
    
    def __init__(self):
        self.handler = AlpacaOrderHandler()
        ...
        logger.info("=" * 80)
        logger.info(f"ASTRA SCHEDULER INITIALIZED")
        logger.info(f"Trading: {ACCOUNT_NAME}")
        logger.info(f"Mode: REAL ALPACA PAPER ORDERS")
        logger.info("=" * 80)
