...
BROKER_CONFIG_KEYS = {
    ...
    "ACTIVE_TRADER", "TRADER_NAME", "TRADER_NAMES", "PAPER_TRADING", "DRY_RUN", "PERSONA_OVERRIDES",
    "CDE_STRATEGIES",   # helper tuple for PERSONA_OVERRIDES entries, Alpaca-persona-only like it
